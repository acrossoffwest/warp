...
use super::{
    schema, AgentPermissionMode, BlockCompleted, FinishedCommandMetadata, ModelEvent,
    PersistedData, PersistedDataScope, PersistenceScope, SessionMemoryKind, SessionMemoryRecord,
    SessionMemoryRunState, SessionMemorySource, SessionMemoryStatus, StartedCommandMetadata,
    WriterHandles,
};
...
fn read_sqlite_data_with_session_memory_run_state(
    ...
    if matches!(data_scope, PersistedDataScope::CodebaseIndicesOnly) {
        return Ok(PersistedData {
            ...
            session_memory_records: Default::default(),
